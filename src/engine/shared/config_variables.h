...
MACRO_CONFIG_STR(SvName, sv_name, 128, "unnamed ictf server", CFGFLAG_SERVER, "Server name")
...
MACRO_CONFIG_STR(SvMap, sv_map, 128, "ctf4_old", CFGFLAG_SERVER, "Map to use on the server")
...
MACRO_CONFIG_INT(SvRegister, sv_register, 0, 0, 1, CFGFLAG_SERVER, "Register server with master server for public listing")
...
MACRO_CONFIG_INT(SvScorelimit, sv_scorelimit, 1000, 0, 10000, CFGFLAG_SERVER, "Score limit (0 disables)")
MACRO_CONFIG_INT(SvTimelimit, sv_timelimit, 0, 0, 1000, CFGFLAG_SERVER, "Time limit in minutes (0 disables)")
MACRO_CONFIG_STR(SvGametype, sv_gametype, 32, "ictf", CFGFLAG_SERVER, "Game type (idm, ictf)")
...
MACRO_CONFIG_STR(SqlDatabase, sql_database, 32, "ddnet", CFGFLAG_SERVER, "Game type (idm, ictf)")
MACRO_CONFIG_STR(SqlPrefix, sql_prefix, 32, "record", CFGFLAG_SERVER, "Game type (idm, ictf)")
MACRO_CONFIG_STR(SqlUser, sql_user, 32, "admin", CFGFLAG_SERVER, "Game type (idm, ictf)")
MACRO_CONFIG_STR(SqlPass, sql_pass, 32, "1234", CFGFLAG_SERVER, "Game type (idm, ictf)")
MACRO_CONFIG_STR(SqlHost, sql_host, 32, "localhost", CFGFLAG_SERVER, "Game type (idm, ictf)")
MACRO_CONFIG_INT(SqlPort, sql_port, 3306, 0, 61000, CFGFLAG_SERVER, "Default warmup-time before a war")
MACRO_CONFIG_INT(SqlSetup, sql_setup, 1, 0, 1, CFGFLAG_SERVER, "Default warmup-time before a war")
...
MACRO_CONFIG_INT(SvVanConnPerSecond, sv_van_conn_per_second, 0, 0, 10000, CFGFLAG_SERVER, "Antispoof specific ratelimit (0 for no limit)")
